...
def main() -> None:
    ...
    probabilities = [0.0455, 0.0027, 6.334e-5, 5.733e-7] # TODO: same array for all 3 telescopes?
    ...
    freq_inj, power_inj = ls_inj.autopower(
        minimum_frequency=0.01,
        maximum_frequency=20,
        samples_per_peak=10,
    )
    ...
    freq_fold, power_fold = ls_fold.autopower(
        minimum_frequency=0.01,
        maximum_frequency=20,
        samples_per_peak=10,
    )
    ...
    freq_inj_fold, power_inj_fold = ls_inj_fold.autopower(
        minimum_frequency=0.01,
        maximum_frequency=20,
        samples_per_peak=10,
    )
